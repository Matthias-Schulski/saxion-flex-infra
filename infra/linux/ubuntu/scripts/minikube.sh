...
sudo install -o root -g root -m 0755 ~/scripts/minikube/kubectl /usr/local/bin/kubectl
...
sudo install -o root -g root -m 0755 ~/scripts/minikube/minikube-linux-amd64 /usr/local/bin/minikube
